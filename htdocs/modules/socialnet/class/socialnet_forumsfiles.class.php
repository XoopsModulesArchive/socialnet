...
include_once XOOPS_ROOT_PATH.'/modules/socialnet/class/socialnet_forummimetype.class.php';

class socialnet_sFiles {
	var $db;
	var $table;
	var $fileid;
	var $filerealname;
    ...
    function socialnet_sFiles($fileid=-1)
    {
		$this->db =& Database::getInstance();
        $this->table = $this->db->prefix('socialnet_forumfiles');
        $this->post_id = 0;
        $this->filerealname = '';
        $this->date = 0;
        $this->mimetype = '';
    ...
    {
		$cmimetype = new socialnet_cmimetype();
    ...
    function getAllbyPost($post_id)
    {
       ...
       while( $myrow = $this->db->fetchArray($result)) {
			$ret[] = new socialnet_sFiles($myrow);
       }
       return $ret;
    }
