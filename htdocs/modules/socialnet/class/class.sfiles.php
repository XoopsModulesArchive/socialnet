...
include_once XOOPS_ROOT_PATH . "/modules/socialnet/class/class.mimetype.php";
...
class sFiles {
    ...
    function sFiles($fileid=-1) 
    {
        ...
        $this->table = $this->db->prefix("socialnet_newsfiles");
        $this->storyid = 0;
        $this->filerealname = "";
        $this->date = '';
        $this->mimetype = "";
	...
	function createUploadName($folder,$filename, $trimname=false)
	{
		...
		if(xoops_substr($workingfolder,strlen($workingfolder)-1,1)<>'/socialnet/news')
		{
			$workingfolder.='/socialnet/news';
		}
