...
function spot_getClass($classe, $id = null){
	static $classes;
	if (!isset($classes[$classe])) {
		if ( file_exists($arquivo = XOOPS_ROOT_PATH . "/modules/socialnet/class/".$classe.".class.php")) {
...
function spot_getModuleConfig($dirname){
