...
if($mpb_10_id > 0){
    ...
    $mpb_button_limpacont->setExtra("onclick=\"document.location= '".XOOPS_URL."/modules/socialnet/admin/treemenu.php?op=limpacont&mpb_10_id=".$mpb_10_id."'\"");
...
$mpb_form->addElement(new XoopsFormSelectUser(_AM_SOCIALNET_USR_10_UID, "usr_10_uid", false, (($socialnet_classe->getVar("usr_10_uid") != "") ? $socialnet_classe->getVar("usr_10_uid") : $xoopsUser->getVar('uid'))));

$mpb_show_tray = new XoopsFormElementTray(_AM_SOCIALNET_MPB_10_IDPAI, "&nbsp;&nbsp;&nbsp;");
$exibir_select = new XoopsFormSelect("", "mpb_10_idpai", $socialnet_classe->getVar("mpb_10_idpai"));
$exibir_select->addOptionArray($socialnet_classe->geraMenuSelect());
$mpb_show_tray->addElement($exibir_select);
...
echo "<br>";
echo "<hr>";
echo "<div style='color: #FF0000; font-size: 20px'>  "._AM_SOCIALNET_PGTITLE."</div>";
echo "<h3><img src='../images/profile/toggle.gif'>" . _AM_SOCIALNET_MPB_FROMFILE . "</h3>";

$mpb_withoutlink = new XoopsFormCheckBox("", "mpb_12_withoutlink", $socialnet_classe->getVar("mpb_12_withoutlink"));
$mpb_withoutlink->setExtra("id='mpb_12_withoutlink' onclick='if(this.checked){ document.getElementById(\"mpb_external\").checked=false; document.getElementById(\"mpb_page\").checked=false; document.getElementById(\"mpb_frame\").checked=false; document.getElementById(\"mpb_external_span\").style.display=\"none\"; document.getElementById(\"mpb_35_content_span\").style.display=\"none\"; document.getElementById(\"mpb_page_span\").style.display=\"none\"; document.getElementById(\"mpb_30_file_span\").style.display=\"none\"; }else{ document.getElementById(\"mpb_35_content_span\").style.display=\"\";}'");
...
$mpb_external_check->setExtra("id='mpb_external' onclick='if(this.checked) { document.getElementById(\"mpb_page\").checked=false; document.getElementById(\"mpb_12_withoutlink\").checked=false; document.getElementById(\"mpb_frame\").checked=false; document.getElementById(\"mpb_external_span\").style.display=\"\"; document.getElementById(\"mpb_30_file_span\").style.display=\"none\"; document.getElementById(\"mpb_page_span\").style.display=\"none\"; document.getElementById(\"mpb_35_content_span\").style.display=\"none\";}else{document.getElementById(\"mpb_external_span\").style.display=\"none\";document.getElementById(\"mpb_35_content_span\").style.display=\"\";}'");
...
// NOTE: TO SOLVE THIS PROBLEM IN LINE 93 REGARDING socialnet_conf_wysiwyg If I erase the line the editor's box it disappears
...
$mpb_tray_content->addElement(new XoopsFormText(_AM_SOCIALNET_MPB_FRAME_URL, 'mpb_30_file_frame', 30, 255, ((substr($socialnet_classe->getVar("mpb_30_file"), 0, 4) == 'http') ? $socialnet_classe->getVar("mpb_30_file") : '')));
...
$mpb_tray_content->addElement(new XoopsFormText(_AM_SOCIALNET_MPB_EXTERNAL_URL, 'mpb_30_file_external', 30, 255, ((substr($socialnet_classe->getVar("mpb_30_file"), 0, 4) == 'ext:') ? substr($socialnet_classe->getVar("mpb_30_file"), 4) : 'http://')));
$mpb_tray_content->addElement(new XoopsFormLabel("", "</span>"));
...
$mpb_tray_content->addElement(new XoopsFormLabel("", "<a href='".XOOPS_URL."/modules/socialnet/admin/treepages.php?op=contentfiles_adicionar'><img src='../images/icons/open.gif'>"._ADD."</a></span>"));
...
$mpb_button_cancel->setExtra("onclick=\"document.location= '".XOOPS_URL."/modules/socialnet/admin/treemenu.php'\"");
