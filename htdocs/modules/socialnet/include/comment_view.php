...
if (XOOPS_COMMENT_APPROVENONE != $xoopsModuleConfig['com_rule']) {
	...
	$com_itemid = (trim($comment_config['itemName']) != '' && isset($_GET[$comment_config['itemName']])) ? $socialnet_classe->getVar("mpb_10_id") : 0;
	if ($com_itemid > 0) {
  ...
  <tr>
    <td class="even" align="center"><select name="com_mode"><option value="flat"';
		...
		if (!empty($xoopsModuleConfig['com_anonpost']) || is_object($xoopsUser)) {
			$postcomment_link = 'treecomment_new.php?com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode;
		...
		$xoopsTpl->assign(array('commentsnav' => $navbar, 'editcomment_link' => '/tree/treecomment_edit.php?com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode.''.$link_extra, 'deletecomment_link' => 'comment_delete.php?com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode.''.$link_extra, 'replycomment_link' => 'treecomment_reply.php?com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode.''.$link_extra));
