...
$cform = new XoopsThemeForm(_CM_POSTCOMMENT, "commentform", 'treecomment_post.php', 'post');
...
if ($xoopsModuleConfig['socialnet_conf_captcha']) {
	$captcha_tray = new XoopsFormElementTray(_MI_SOCIALNET_CAPTCHA_LABEL);
	$captcha_tray->addElement(new XoopsFormLabel("", "<img src='".XOOPS_URL."/modules/socialnet/include/captcha/php-captcha.php' align='absmiddle'>"));
