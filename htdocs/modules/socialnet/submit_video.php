...
if($album_factory->insert($newvideo))
{
	...
	redirect_header(XOOPS_URL.'/modules/socialnet/youtube.php?uid='.intval($xoopsUser->getVar('uid')),2,_MD_SOCIALNET_VIDEOSAVED);
}
else {redirect_header(XOOPS_URL.'/modules/socialnet/youtube.php?uid='.intval($xoopsUser->getVar('uid')),2,_MD_SOCIALNET_ANERROR);}
