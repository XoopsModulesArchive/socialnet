...
$pdf_config['creator'] = 'SOCIALNET BASED ON FPDF v1.53';
...
$pdf_config['footerpage'] = _MD_SOCIALNET_PDF_PAGE;

// For local support sites
define('SOCIALNET_PDF_FORUM', 'Forum');
define('SOCIALNET_PDF_TOPIC', 'Topic');
define('SOCIALNET_PDF_SUBJECT', 'Subject');
define('SOCIALNET_PDF_AUTHOR', _POSTEDBY);
define('SOCIALNET_PDF_DATE', _MD_SOCIALNET_POSTEDON);
