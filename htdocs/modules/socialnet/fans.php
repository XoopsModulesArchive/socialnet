...
$xoopsOption['template_main'] = 'socialnet_fans.html';
...
if($nb_friends ==0) {$xoopsTpl->assign('lang_nofansyet',_MD_SOCIALNET_NOFANSYET);}
...
*/
$bar_navigation = new XoopsPageNav($nb_friends,$xoopsModuleConfig['friendsperpage'],$start,'start','uid='.intval($controler->uidOwner));
...
$xoopsTpl->assign('lang_fanstitle',  sprintf(_MD_SOCIALNET_FANSTITLE,$identifier));
