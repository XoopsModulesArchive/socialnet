...
redirect_header(XOOPS_URL."/modules/socialnet/index.php?uid=".$_POST['petitioned_uid'],3,_MD_SOCIALNET_ALREADY_PETITIONED);
} else {
...
redirect_header(XOOPS_URL."/modules/socialnet/index.php?uid=".$_POST['petitioned_uid'],3,_MD_SOCIALNET_ALREADY_PETITIONED);
              ...
              */
              ...
              $notification_handler->triggerEvent ("friendship", $_POST['petitioned_uid'] , "new_friendship",$extra_tags);       
                     ...
                     redirect_header(XOOPS_URL."/modules/socialnet/index.php?uid=".$_POST['petitioned_uid'],3,_MD_SOCIALNET_PETITIONED);
              } else {
                     redirect_header(XOOPS_URL."/modules/socialnet/index.php?uid=".$xoopsUser->getVar('uid'),3,_MD_SOCIALNET_ANERROR);
              }
