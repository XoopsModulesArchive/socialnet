...
{
	xoops_confirm(array('cod_img'=> $cod_img,'confirm'=>1), 'delpicture.php', _MD_SOCIALNET_ASKCONFIRMDELETION, _MD_SOCIALNET_CONFIRMDELETION);
}
else
{
	/**
	...
	*/
	if($album_factory->deleteAll($criteria))
	{
		...
		redirect_header('album.php', 2, _MD_SOCIALNET_DELETED);
	}
