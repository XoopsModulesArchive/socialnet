...
function socialnet_menuhor_exibe($options){
	...
	$block['menuHOR'] = $socialnet_classe->geraMenuCSS($exibe_subpgs, (($options[25] == 0) ? $options[3] : false));
    $block['variante'] = $options[0];
	return $block;
}
function socialnet_menuhor_edita($options){
	include_once XOOPS_ROOT_PATH."/modules/socialnet/class/socialnet_mpb_mpublish.class.php";
