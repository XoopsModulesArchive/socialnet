...
function socialnet_menurelated_exibe($options){
	...
	if(!$tac){
		...
		if ($socialnet_classe->getVar("mpb_10_id") != "" && $socialnet_classe->getVar("mpb_10_idpai") != 0) {
			...
			if ($socialnet_classe->contar($rel_crit) <= 0) {
				return false;
			}
			...
			$block['menuRelated'] = $socialnet_classe->geraMenuRelated(null);
...
function socialnet_menurelated_edita($options){
...
PICKER;
	...
	$form .= _MB_SOCIALNET_BLO_OPT_WIDTH." <input type='text' size='4' name='options[1]' value='".$options[1]."' /><br />";
	$form .= _MB_SOCIALNET_BLO_OPT_WIDTH_SUB." <input type='text' size='4' name='options[2]' value='".$options[2]."' /><br />";
	$form .= _MB_SOCIALNET_BLO_OPT_URLARROW." <input type='text' size='35' name='options[3]' value='".$options[3]."' onblur=\"document.getElementById('menuImage').src=this.value\" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img id='menuImage' src='".$options[3]."'><br />";
	...
	$form .= _MB_SOCIALNET_BLO_OPT_BORDER." <input size='4' type='text' name='options[15]' value='".$options[15]."' /> <select name='options[16]'>
	<option value='none'";
	...
	$form .= _MB_SOCIALNET_BLO_OPT_BORDERO." <input size='4' type='text' name='options[18]' value='".$options[18]."' /> <select name='options[19]'>
	<option value='none'";
	...
	$form .= _MB_SOCIALNET_BLO_OPT_PADDING." <input type='text' size='4' name='options[21]' value='".$options[21]."' /><br />";
	return $form;
}
  ?>