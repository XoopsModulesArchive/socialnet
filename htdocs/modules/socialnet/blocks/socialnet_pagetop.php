 ...
 */
function b_socialnet_top2_show($options)	// 10=Items count, 30=Title's length
{
	$block = array();
	$start = 0;
 ...
 * The edit function
 */
function b_socialnet_top2_edit($options)		// 10=Items count, 30=Title's length
{
	$form= '';
...
* Block, "on the fly".
*/
function b_socialnet_top_onthefly($options)
{
	$options = explode('|',$options);
	$block = & b_socialnet_top2_show($options);

	$tpl = new XoopsTpl();
	$tpl->assign('block', $block);
	$tpl->display('db:socialnet_block_top.html');
}
?>