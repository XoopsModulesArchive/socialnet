...
$xoopsOption['template_main'] = 'socialnet_langtool.html';
require('langheader.php');
...
$content = navbar().'<br>';
if(isset($_SESSION['socialnet']['module']))
//  $content .= _MD_SOCIALNET_LANGTOOL_INMODULE . $_SESSION['socialnet']['module'] . '/language/*';
  $content .= _MD_SOCIALNET_LANGTOOL_INMODULE . $_SESSION['socialnet']['base_dir'];
if(isset($_SESSION['socialnet']['path']))
  $content .= $_SESSION['socialnet']['path'];
$content .= '<hr><form method="post">';
$pattern = LANG_TOOL_PATTERN;
switch($_SESSION['socialnet']['step']){
  case 5:
    include 'langstep5.php';
  break;
  case 4:
    include 'langstep4.php';
  case 3:
    include 'langstep3.php';
  break;
  case 2:
    include 'langstep2.php';
  break;
  case 1:
  default:
    include 'langstep1.php';
}
$content .= '</form>';
...
$xoopsTpl->assign('lang_mysection',_MD_SOCIALNET_LANGTOOL_MENU);
$xoopsTpl->assign('section_name',_MD_SOCIALNET_LANGTOOL_MENU);
...
$xoopsTpl->assign('lang_languages', _MD_SOCIALNET_LANGTOOL_MENU);
