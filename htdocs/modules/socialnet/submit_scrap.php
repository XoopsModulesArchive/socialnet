...
if ($mainform==1){
	redirect_header("scrapbook.php?uid=".$scrapbook_uid,1,_MD_SOCIALNET_SCRAP_SENT);
}else{
	redirect_header("scrapbook.php?uid=".$xoopsUser->getVar('uid'),1,_MD_SOCIALNET_SCRAP_SENT);
}
