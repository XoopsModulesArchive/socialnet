...
$xoopsOption['template_main'] = 'socialnet_pagelist.html';
...
// Page's title
$xoopsTpl->assign('xoops_pagetitle', strip_tags(_MD_SOCIALNET_PAGELIST).' - '.$myts->htmlSpecialChars($xoopsModule->name()));
...
$xoopsTpl->assign('lang_mysection',_MD_SOCIALNET_PAGELIST);
$xoopsTpl->assign('section_name',_MD_SOCIALNET_PAGELIST);
