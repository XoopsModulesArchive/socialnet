...
$xoopsOption['template_main'] = 'socialnet_friends.html';
...
$controler = new SocialnetControlerFriends($xoopsDB,$xoopsUser);
...
if($nb_friends ==0) {$xoopsTpl->assign('lang_nofriendsyet',_MD_SOCIALNET_NOFRIENDSYET);}
...
*/
$bar_navigation = new XoopsPageNav($nbSections['nbFriends'],$xoopsModuleConfig['friendsperpage'],$start,'start','uid='.intval($controler->uidOwner));
...
$xoopsTpl->assign('lang_mysection',_MD_SOCIALNET_MYFRIENDS);
$xoopsTpl->assign('section_name',_MD_SOCIALNET_FRIENDS);
...
$xoopsTpl->assign('lang_friendstitle', sprintf(_MD_SOCIALNET_FRIENDSTITLE,$identifier));
...
$xoopsTpl->assign('lang_evaluate',_MD_SOCIALNET_FRIENDSHIPCONFIGS );
