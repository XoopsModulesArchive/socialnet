...
if($uid == $video->getVar('uid_owner'))
{
	...
	{
		if($video_factory->insert($video)) {redirect_header('youtube.php', 2, _MD_SOCIALNET_SETMAINVIDEO);}
		else {redirect_header('youtube.php', 2, _MD_SOCIALNET_ANERROR);}
	}
	else {echo "is not correct";}
}
