...
adminmenu(2);
    ...
    function list_blocks()
    {
        ...
        ksort($module_list);
		echo "
        <h4 style='text-align:left;'>"._MI_SOCIALNET_NAME_MOD." - "._AM_BADMIN."</h4>";
        $module_handler =& xoops_gethandler('module');
        echo "<form action='".$_SERVER['PHP_SELF']."' name='blockadmin' method='post'>
        <table width='100%' class='outer' cellpadding='4' cellspacing='1'>
        <tr valign='middle'><th align='center' >"._AM_TITLE."</th><th align='center' nowrap='nowrap'>"._AM_SIDE."<br />"._LEFT."-"._CENTER."-"._RIGHT."</th><th align='center'>"._AM_WEIGHT."</th><th align='center'>"._AM_VISIBLE."</th><th align='center'>"._AM_VISIBLEIN."</th><th align='center'>"._AM_SOCIALNET_GROUPS."</th><th align='center'>"._AM_ACTION."</th></tr>";
        ...
        foreach ($block_arr as $i) {
            ...
            echo "<td class='$class' align='center' ><a href='".XOOPS_URL."/modules/system/admin.php?fct=blocksadmin&amp;op=edit&amp;bid=".$i->getVar("bid")."'><img src='../images/icons/edit.gif' />"._EDIT."</a><br /> <a href='blocksadmin.php?op=clone&amp;bid=".$i->getVar("bid")."'><img src='../images/icons/clone.gif' />"._CLONE."</a>";
    ...
    function setar_order($bid, $title, $weight, $visible, $side)
    {
        $myblock = new XoopsBlock($bid);
    ...
    if ( $op == "order" ) {
        ...
        foreach (array_keys($bid) as $i) {
            ...
            setar_order($bid[$i], $title[$i], $weight[$i], $visible[$i], $side[$i], $bmodule[$i]);
        ...
        redirect_header($_SERVER['PHP_SELF'],1,_AM_SOCIALNET_SUCESS);
        exit();
    }
    if ($op == 'clone') {
        clone_block($bid);
