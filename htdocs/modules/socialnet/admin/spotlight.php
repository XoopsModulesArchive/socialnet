...
switch ($op) {
    ...
    default:
        ...
        $spotlightBlock = $block_handler->getObjects(new Criteria('b.func_file', "socialnet_newsspotlight.php"));
        ...
        $output = "<div align='right'>
                        <a href='spotlight.php?op=add'><img src='../images/icons/scraps.gif' />"._AM_SOCIALNET_SPOT_ADD."</a>";
        if (is_object($spotlightBlock)) {
            $output .= "<br />
                        <a href='blocksadmin.php'><img src='../images/icons/edit.gif' />"._AM_SOCIALNET_SPOT_EDITBLOCK."</a>";
        }
        $output .= "</div>";
        ...
        $output .= "<tr><th>"._AM_SOCIALNET_SPOT_NAME."</th><th></th><th>"._AM_SOCIALNET_SPOT_IMAGE."</th><th>"._AM_SOCIALNET_SPOT_WEIGHT."</th><th>"._AM_SOCIALNET_SPOT_DISPLAY."</th><th>"._AM_SOCIALNET_ACTION."</th>";
        ...
        if (count($spotlights) > 0) {
            foreach (array_keys($spotlights) as $i) {
                ...
                $output .= "<td><a href='spotlight.php?op=edit&amp;id=".$spotlights[$i]['spotid']."'>". _AM_SOCIALNET_EDIT."</a>";
                $output .= "&nbsp;<a href='spotlight.php?op=delete&amp;id=".$spotlights[$i]['spotid']."'>"._AM_SOCIALNET_DELETE."</a></td>";
                $output .= "</tr>";
                unset($weight_select);
        ...
        $output .= "<tr>
                        ...
                        <td colspan='2' align='center'>
                            ...
                            <input type='submit' name='submit' value='"._AM_SOCIALNET_SUBMIT."' />
                        </td>
                        <td></td>
                    </tr>";
    ...
    case "save":
        ...
        if ($spotlight_handler->insert($spot)) {
            redirect_header('spotlight.php', 3, _AM_SOCIALNET_SPOT_SAVESUCCESS);
        }
        else {
    ...
    case "delete":
        if (isset($_REQUEST['ok']) && intval($_REQUEST['ok']) === 1) {
            ...
            if ($spotlight_handler->delete($spot)) {
                redirect_header('spotlight.php', 3, _AM_SOCIALNET_SPOT_DELETESUCCESS);
            }
            else {
                echo $spot->getHtmlErrors();
            }
            ...
            xoops_confirm(array('ok' => 1, 'id' => $_REQUEST['id'], 'op' => 'delete'), 'spotlight.php', _AM_SOCIALNET_RUSUREDELSPOTLIGHT);
        }
        break;
